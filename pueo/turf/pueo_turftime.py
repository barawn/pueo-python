...
#  +------------------+------------+------+-----+------------+-------------------------------------------------+    
    ...
    last_pps          = register_ro(0x00C,                   "Cycles @ last PPS. Read current_second to capture w/other timing regs")
    llast_pps         = register_ro(0x010,                   "Cycles @ PPS prior to last. Read current second to capture w/other timing regs")
